...
//		antMatchers("/student-api/**","/address-api/**").hasAnyAuthority("ADMIN").
				...
				antMatchers("/buyer/place-bid","/buyer/delete/**","/buyer/fetchAllBids/**","/update-bid/**",
						"/seller/addProduct","/seller/delete/**","/seller/listProducts/**").permitAll().
				...
				antMatchers("/buyer/fetchProduct/**","/seller/show-bids/**").hasAnyAuthority("ADMIN").
