...
import com.cts.fse.eauction.buyer.config.aws.Container;
import com.cts.fse.eauction.buyer.config.aws.Converter;
import com.cts.fse.eauction.buyer.config.aws.EcsTaskMetadata;
import com.cts.fse.eauction.buyer.config.aws.Network;
...
public class CloudConfiguration {
    ...
    private static final String DOCKER_CONTAINER_NAME = "sellerservice";
    ...
    public EurekaInstanceConfigBean eurekaInstanceConfig(InetUtils inetUtils) {
        ...
        try {
            ...
            log.info("Override Port Number to " + getPortNumber());
        } catch (Exception ex){
